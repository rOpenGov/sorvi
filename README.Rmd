...
This package was originally intended for various algorithms for Finnish open goverment data using [R](http://www.r-project.org). Now it hosts various functions that are helpful in package maintenance and authoring but do not fit in other, more specialized packages.
